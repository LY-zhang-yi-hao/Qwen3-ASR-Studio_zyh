...
export const PipView: React.FC<PipViewProps> = ({ 
  ...
  bailianApiKey 
    ...
    const isCtrlSpaceActiveRef = useRef(false);
    ...
    useEffect(() => {
        ...
        const handleKeyDown = (event: KeyboardEvent) => {
            ...
            if (ctrlPressed && spacePressed && !isCtrlSpaceActiveRef.current) {
                event.preventDefault();
                isCtrlSpaceActiveRef.current = true;
                if (status !== 'recording') {
                    startRecording();
                }
            }
        ...
        const handleKeyUp = (event: KeyboardEvent) => {
            ...
            if ((!ctrlPressed || !spacePressed) && isCtrlSpaceActiveRef.current) {
                event.preventDefault();
                isCtrlSpaceActiveRef.current = false;
                if (status === 'recording') {
                    stopRecording();
                }
            }
